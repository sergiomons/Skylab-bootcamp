 ...
 // functions
  ...
  function continueIni() {
     shownCom.style="padding: 10px 5px 10px 15px; font-size: 25px; text-align: center;margin-top: 100px; width: 65%; margin-left: 250px";;
  ...
  function confName() {
      ...
      butStart.type="button"; butStart.id="butStart"; butStart.className="button"; butStart.name="butStart"; butStart.value="Start Game";
  ...
  function toPressStart() {
      ...
      var timeBegin = 6;
      var p2=document.createElement("p"); p2.id="p2"; p2.style="font-size: 33px; margin-bottom: 0px";
      shownCom.appendChild(p2);
      var p3=document.createElement("p3"); p3.id="p3"; p3.style="color:orange; text-align: center; font-size: 33px";
  ...
  function refresh() {
        ...
        timeLeft=document.getElementById("showTime").innerHTML;;
        off="yes";
